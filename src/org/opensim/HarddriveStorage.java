...
public class HarddriveStorage implements Storage {
	...
	/** the name of the host storage is attached . */
	...
	public void init(int i) {
		...
		Log.printLine("disk latency(sec):"+ Double.toString(latency) +"\n avg seek time(sec) :" + Double.toString(avgSeekTime) + "\n maxTransferRate(Mbytes) :" +  Double.toString(maxTransferRate)+"\n");
	}
