...
import org.opensim.storage.OpenPowerVmAllocation;
...
public abstract class RunnerAbstract2 {
	...
	public RunnerAbstract2(
		...
		init(inputFolderRead,inputFolderWrite,inputFolderCpu);
		start(
	 ...
	 * @param inputFolder the input folder
	 */
	protected abstract void init(String inputFolderRead,String inputFolderWrite,String inputFolderCpu);
	...
	protected VmAllocationPolicy getVmAllocationPolicy(
		...
		if (vmAllocationPolicyName.equals("iqr")) {
			...
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
					...
					vmSelectionPolicy,
					parameter);
		} else if (vmAllocationPolicyName.equals("openstack")) {
