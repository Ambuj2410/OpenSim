...
public class OpenPowerVmAllocation extends PowerVmAllocationPolicyAbstract {
	...
	public OpenPowerVmAllocation(List<? extends Host> list) {
		super(list);
			...
			do {// we still trying until we find a host or until we try all of them
				...
				for (int i = 0; i < freePesTmp.size(); i++) {
					if (freePesTmp.get(i) > pe) {
						...
						idx = i;
						this.filteredHostList.add(getHostList().get(i));
					}
				}
