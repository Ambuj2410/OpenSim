...
public class OpensimExample2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Log.printLine("OpensimExample2 finished!");
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	private static Datacenter createDatacenter(String name){
		...
		try {
			datacenter = new Datacenter(name, characteristics, new OpenVmAllocation(hostList), storageList, 0);
		} catch (Exception e) {
			e.printStackTrace();
		}
